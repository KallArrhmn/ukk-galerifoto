        ...
        <div class="w-25 my-5 rounded p-4 shadow-lg">
            ...
            <form action="{{ route('photo.postProcess') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="judul_foto" id="judul_foto" placeholder="">
                    @error('judul_foto')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi_foto" id="deskripsi_foto" rows="4" class="form-control"></textarea>
